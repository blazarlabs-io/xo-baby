...
export default function AddKidGenderScreen() {
  const navigation = useNavigation<NativeStackNavigationProp<AppStackParamList, 'AddKidGender'>>();
  const route = useRoute<RouteProp<AppStackParamList, 'AddKidGender'>>();
