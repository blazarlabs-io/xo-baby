...
export default function SignupPasswordScreen() {
  ...
  const navigation = useNavigation<NativeStackNavigationProp<AuthStackParamList, 'SignupPasswordScreen'>>();
  const route = useRoute<RouteProp<AuthStackParamList, 'SignupPasswordScreen'>>();
