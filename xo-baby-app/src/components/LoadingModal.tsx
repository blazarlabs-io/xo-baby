    ...
    switch (stage) {
      case 'blockchain':
        return {
          ...
          description: 'Setting up wallet and creating child ID on Midnight network...',
          estimatedTime: '~1 minute'
        };
      case 'encrypting':
        return {
          title: 'Encrypting Data',
          description: 'Securing your child\'s information with AES encryption...',
...
const getProgressWidth = (stage: string) => {
  switch (stage) {
    case 'blockchain': return '25%';
    case 'encrypting': return '50%';
...
const getProgressText = (stage: string) => {
  switch (stage) {
    case 'blockchain': return 'Step 1 of 4';
    case 'encrypting': return 'Step 2 of 4';
    case 'uploading': return 'Step 3 of 4';
    case 'finalizing': return 'Step 4 of 4';
