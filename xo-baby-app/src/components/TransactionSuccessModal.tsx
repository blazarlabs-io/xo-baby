...
export default function TransactionSuccessModal({
  ...
  const copyToClipboard = async () => {
    ...
    try {
      ...
      Alert.alert("Error", "Failed to copy transaction hash", [{ text: "OK" }]);
    }
  };
          ...
          >
            <View style={styles.content}>
              ...
              <Text style={styles.infoText}>
                This transaction hash proves your kid's data is securely stored
                on the blockchain. You can use it to verify the transaction
                anytime.
              </Text>
