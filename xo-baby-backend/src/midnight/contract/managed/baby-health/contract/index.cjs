...
class _Datum_0 {
  ...
  fromValue(value_0) {
    return {
      nftId: _descriptor_0.fromValue(value_0),
      CID: _descriptor_0.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.nftId).concat(_descriptor_0.toValue(value_0.CID));
  }
}

const _descriptor_1 = new _Datum_0();
...
class _RoleNFT_0 {
  ...
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.recipient).concat(_descriptor_0.toValue(value_0.role).concat(_descriptor_0.toValue(value_0.childId).concat(_descriptor_0.toValue(value_0.validUntil))));
  }
}

const _descriptor_2 = new _RoleNFT_0();
...
class _AccessPolicy_0 {
  ...
  fromValue(value_0) {
    return {
      nftId: _descriptor_0.fromValue(value_0),
      rights: _descriptor_0.fromValue(value_0),
      expiry: _descriptor_0.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.nftId).concat(_descriptor_0.toValue(value_0.rights).concat(_descriptor_0.toValue(value_0.expiry)));
  }
}

const _descriptor_3 = new _AccessPolicy_0();
...
class _CSet_0 {
  ...
  fromValue(value_0) {
    return {
      nftId: _descriptor_0.fromValue(value_0),
      AESkey: _descriptor_0.fromValue(value_0)
    }
  }
  toValue(value_0) {
    return _descriptor_0.toValue(value_0.nftId).concat(_descriptor_0.toValue(value_0.AESkey));
  }
}

const _descriptor_5 = new _CSet_0();

const _descriptor_6 = new __compactRuntime.CompactTypeUnsignedInteger(340282366920938463463374607431768211455n, 16);

const _descriptor_7 = new __compactRuntime.CompactTypeUnsignedInteger(18446744073709551615n, 8);

const _descriptor_8 = new __compactRuntime.CompactTypeField();
...
const _descriptor_11 = new __compactRuntime.CompactTypeVector(3, _descriptor_8);
...
const _descriptor_13 = new __compactRuntime.CompactTypeBoolean();
...
class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      generateRoleBasedNFT: (...args_1) => {
        if (args_1.length !== 6)
          throw new __compactRuntime.CompactError(`generateRoleBasedNFT: expected 6 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const nftId_0 = args_1[1];
        const childId_0 = args_1[2];
        const recipient_0 = args_1[3];
        const role_0 = args_1[4];
        const validUntil_0 = args_1[5];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('generateRoleBasedNFT',
                                      'argument 1 (as invoked from Typescript)',
                                      'baby.compact line 69 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(nftId_0).concat(_descriptor_0.toValue(childId_0).concat(_descriptor_0.toValue(recipient_0).concat(_descriptor_0.toValue(role_0).concat(_descriptor_0.toValue(validUntil_0))))),
      ...
      generateCSet: (...args_1) => {
        if (args_1.length !== 3)
          throw new __compactRuntime.CompactError(`generateCSet: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const nftId_0 = args_1[1];
        const AESkey_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('generateCSet',
                                      'argument 1 (as invoked from Typescript)',
                                      'baby.compact line 99 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        if (!(nftId_0.buffer instanceof ArrayBuffer && nftId_0.BYTES_PER_ELEMENT === 1 && nftId_0.length === 32))
          __compactRuntime.type_error('generateCSet',
                                      ...
                                      'Bytes<32>',
                                      nftId_0)
        if (!(AESkey_0.buffer instanceof ArrayBuffer && AESkey_0.BYTES_PER_ELEMENT === 1 && AESkey_0.length === 32))
          __compactRuntime.type_error('generateCSet',
                                      'argument 2 (argument 3 as invoked from Typescript)',
                                      'baby.compact line 99 char 1',
                                      'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(nftId_0).concat(_descriptor_0.toValue(AESkey_0)),
        ...
        const result_0 = this.#_generateCSet_0(context,
                                               partialProofData,
                                               nftId_0,
                                               AESkey_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      getAESKeyFromCSet: (...args_1) => {
        if (args_1.length !== 2)
          throw new __compactRuntime.CompactError(`getAESKeyFromCSet: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const nftId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('getAESKeyFromCSet',
                                      'argument 1 (as invoked from Typescript)',
                                      'baby.compact line 109 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        if (!(nftId_0.buffer instanceof ArrayBuffer && nftId_0.BYTES_PER_ELEMENT === 1 && nftId_0.length === 32))
          __compactRuntime.type_error('getAESKeyFromCSet',
        ...
        const result_0 = this.#_getAESKeyFromCSet_0(context,
                                                    partialProofData,
                                                    nftId_0);
        partialProofData.output = { value: _descriptor_5.toValue(result_0), alignment: _descriptor_5.alignment() };
        return { result: result_0, context: context, proofData: partialProofData };
      },
      generateAccessPolicy: (...args_1) => {
        if (args_1.length !== 4)
          throw new __compactRuntime.CompactError(`generateAccessPolicy: expected 4 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const nftId_0 = args_1[1];
        const rights_0 = args_1[2];
        const expiry_0 = args_1[3];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('generateAccessPolicy',
                                      'argument 1 (as invoked from Typescript)',
                                      'baby.compact line 121 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        if (!(nftId_0.buffer instanceof ArrayBuffer && nftId_0.BYTES_PER_ELEMENT === 1 && nftId_0.length === 32))
          __compactRuntime.type_error('generateAccessPolicy',
                                      ...
                                      'Bytes<32>',
                                      nftId_0)
        if (!(rights_0.buffer instanceof ArrayBuffer && rights_0.BYTES_PER_ELEMENT === 1 && rights_0.length === 32))
          __compactRuntime.type_error('generateAccessPolicy',
                                      'argument 2 (argument 3 as invoked from Typescript)',
                                      'baby.compact line 121 char 1',
                                      'Bytes<32>',
                                      rights_0)
        if (!(expiry_0.buffer instanceof ArrayBuffer && expiry_0.BYTES_PER_ELEMENT === 1 && expiry_0.length === 32))
          __compactRuntime.type_error('generateAccessPolicy',
                                      'argument 3 (argument 4 as invoked from Typescript)',
                                      'baby.compact line 121 char 1',
                                      'Bytes<32>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(nftId_0).concat(_descriptor_0.toValue(rights_0).concat(_descriptor_0.toValue(expiry_0))),
            alignment: _descriptor_0.alignment().concat(_descriptor_0.alignment().concat(_descriptor_0.alignment()))
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this.#_generateAccessPolicy_0(context,
                                                       partialProofData,
                                                       nftId_0,
                                                       rights_0,
                                                       expiry_0);
      ...
      getRangeFromAccessPolicy: (...args_1) => {
        if (args_1.length !== 2)
          throw new __compactRuntime.CompactError(`getRangeFromAccessPolicy: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const nftId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('getRangeFromAccessPolicy',
                                      'argument 1 (as invoked from Typescript)',
                                      'baby.compact line 132 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        if (!(nftId_0.buffer instanceof ArrayBuffer && nftId_0.BYTES_PER_ELEMENT === 1 && nftId_0.length === 32))
          __compactRuntime.type_error('getRangeFromAccessPolicy',
        ...
        const result_0 = this.#_getRangeFromAccessPolicy_0(context,
                                                           partialProofData,
                                                           nftId_0);
        partialProofData.output = { value: _descriptor_3.toValue(result_0), alignment: _descriptor_3.alignment() };
        return { result: result_0, context: context, proofData: partialProofData };
      },
      generateDatum: (...args_1) => {
        if (args_1.length !== 3)
          throw new __compactRuntime.CompactError(`generateDatum: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const nftId_0 = args_1[1];
        const CID_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('generateDatum',
                                      'argument 1 (as invoked from Typescript)',
                                      'baby.compact line 143 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        if (!(nftId_0.buffer instanceof ArrayBuffer && nftId_0.BYTES_PER_ELEMENT === 1 && nftId_0.length === 32))
          __compactRuntime.type_error('generateDatum',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(nftId_0).concat(_descriptor_0.toValue(CID_0)),
            alignment: _descriptor_0.alignment().concat(_descriptor_0.alignment())
          },
          output: undefined,
          publicTranscript: [],
        ...
        const result_0 = this.#_generateDatum_0(context,
                                                partialProofData,
                                                nftId_0,
                                                CID_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      getDataFromDatum: (...args_1) => {
        if (args_1.length !== 2)
          throw new __compactRuntime.CompactError(`getDataFromDatum: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        const contextOrig_0 = args_1[0];
        const nftId_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.originalState != undefined && contextOrig_0.transactionContext != undefined))
          __compactRuntime.type_error('getDataFromDatum',
                                      'argument 1 (as invoked from Typescript)',
                                      'baby.compact line 152 char 1',
                                      'CircuitContext',
                                      contextOrig_0)
        if (!(nftId_0.buffer instanceof ArrayBuffer && nftId_0.BYTES_PER_ELEMENT === 1 && nftId_0.length === 32))
          __compactRuntime.type_error('getDataFromDatum',
        ...
        const result_0 = this.#_getDataFromDatum_0(context,
                                                   partialProofData,
                                                   nftId_0);
    ...
    this.impureCircuits = {
      ...
      generateCSet: this.circuits.generateCSet,
      getAESKeyFromCSet: this.circuits.getAESKeyFromCSet,
      generateAccessPolicy: this.circuits.generateAccessPolicy,
      getRangeFromAccessPolicy: this.circuits.getRangeFromAccessPolicy,
      generateDatum: this.circuits.generateDatum,
      getDataFromDatum: this.circuits.getDataFromDatum,
  ...
  initialState(...args_0) {
    ...
    state_0.setOperation('generateCSet', new __compactRuntime.ContractOperation());
    state_0.setOperation('getAESKeyFromCSet', new __compactRuntime.ContractOperation());
    state_0.setOperation('generateAccessPolicy', new __compactRuntime.ContractOperation());
    state_0.setOperation('getRangeFromAccessPolicy', new __compactRuntime.ContractOperation());
    state_0.setOperation('generateDatum', new __compactRuntime.ContractOperation());
    state_0.setOperation('getDataFromDatum', new __compactRuntime.ContractOperation());
                    ...
                    [
                     ...
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(tmp_1),
                                                                            alignment: _descriptor_0.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } }]);
    const childId_0 = this.#_persistentHash_0(context,
                                              partialProofData,
  ...
  #_generateNFTId_0(context, partialProofData, firstname_0, lastname_0, email_0)
  {
    ...
    Contract._query(context,
                    ...
                    [
                     ...
                     { ins: { cached: true, n: 1 } }]);
    const tokenId_0 = this.#_persistentHash_1(context,
                                              partialProofData,
                           ...
                           validUntil_0)
  {
    ...
    Contract._query(context,
                    ...
                    [
                     ...
                     { ins: { cached: true, n: 1 } }]);
    const roleNFT_0 = { recipient: recipient_0,
                        role: role_0,
                        childId: childId_0,
                    ...
                    [
                     ...
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(nftId_0),
                                                                            alignment: _descriptor_0.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_2.toValue(roleNFT_0),
  ...
  #_generateCSet_0(context, partialProofData, nftId_0, AESkey_0) {
    const tmp_0 = 1n;
    Contract._query(context,
                    partialProofData,
                    [
                     ...
                     { ins: { cached: true, n: 1 } }]);
    const cSet_0 = { nftId: nftId_0, AESkey: AESkey_0 };
    Contract._query(context,
                    partialProofData,
                    [
                     { idx: { cached: false,
                     ...
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(nftId_0),
                                                                            alignment: _descriptor_0.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_5.toValue(cSet_0),
                                                                            alignment: _descriptor_5.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } },
                     { ins: { cached: true, n: 1 } }]);
    return [];
  }
  #_getAESKeyFromCSet_0(context, partialProofData, nftId_0) {
  ...
  #_generateAccessPolicy_0(context,
                           partialProofData,
                           nftId_0,
                           rights_0,
                           expiry_0)
  {
    ...
    Contract._query(context,
                    ...
                    [
                     ...
                     { ins: { cached: true, n: 1 } }]);
    const accessPolicy_0 = { nftId: nftId_0, rights: rights_0, expiry: expiry_0 };
    Contract._query(context,
                    partialProofData,
                    [
                     { idx: { cached: false,
                     ...
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(nftId_0),
                                                                            alignment: _descriptor_0.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_3.toValue(accessPolicy_0),
                                                                            alignment: _descriptor_3.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } },
                     { ins: { cached: true, n: 1 } }]);
    return [];
  }
  #_getRangeFromAccessPolicy_0(context, partialProofData, nftId_0) {
  ...
  #_generateDatum_0(context, partialProofData, nftId_0, CID_0) {
    const tmp_0 = 1n;
    Contract._query(context,
                    partialProofData,
                    [
                     ...
                     { ins: { cached: true, n: 1 } }]);
    const datum_0 = { nftId: nftId_0, CID: CID_0 };
    Contract._query(context,
                    partialProofData,
                    [
                     { idx: { cached: false,
                     ...
                     { push: { storage: false,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(nftId_0),
                                                                            alignment: _descriptor_0.alignment() }).encode() } },
                     { push: { storage: true,
                               value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(datum_0),
                                                                            alignment: _descriptor_1.alignment() }).encode() } },
                     { ins: { cached: false, n: 1 } },
                     { ins: { cached: true, n: 1 } }]);
    return [];
  }
  #_getDataFromDatum_0(context, partialProofData, nftId_0) {
